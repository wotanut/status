...
class bot_watch(app_commands.Group):
    ...
    bot = app_commands.Group(name='bot', description='All commands related to bots')

    @bot.command(description="Check the status of a bot")
    ...
    @bot.command(description="Clears every mention of your guild from the database")
    ...
    @bot.command(description="Adds a bot to watch for status changes")
