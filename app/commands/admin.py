...
class admin(commands.Cog):
    ...
    @app_commands.command(name="ban_guild", description="Bans a guild from using the bot",guild=discord.Object(id=939479619587952640))
    ...
    @app_commands.command(name="unban_guild", description="Unbans a guild from using the bot",guild=discord.Object(id=939479619587952640))
    @app_commands.checks.has_role(939481851939135548)
    ...
    @app_commands.command(name="ban_user", description="Bans a user from using the bot",guild=discord.Object(id=939479619587952640))
    @app_commands.checks.has_role(939481851939135548)
    ...
    @app_commands.command(name="unban_user", description="Unbans a user from using the bot",guild=discord.Object(id=939479619587952640))
    @app_commands.checks.has_role(939481851939135548)
    ...
    @app_commands.command(name="ban_service", description="Bans a service from using the bot",guild=discord.Object(id=939479619587952640))
    @app_commands.checks.has_role(939481851939135548)
    ...
    @app_commands.command(name="unban_service", description="Unbans a service from using the bot",guild=discord.Object(id=939479619587952640))
    @app_commands.checks.has_role(939481851939135548)
